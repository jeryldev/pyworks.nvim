...
vim.api.nvim_create_user_command("PyworksHelp", function()
	...
	local help = {
		...
		"    <leader>jR   Run all cells in buffer            <leader>jg   Go to cell N",
		"",
		...
		"    <leader>jo   Show output window                 <leader>jf   Toggle folding on/off",
		"    <leader>jh   Hide output window                 <leader>jc   Collapse current cell",
		"    <leader>jd   Delete cell output                 <leader>jC   Collapse all cells",
		"    K            Show output or LSP hover           <leader>je   Expand current cell",
		"                                                    <leader>jE   Expand all cells",
		"  KERNEL MANAGEMENT                               <leader>jn   Refresh cell numbers",
		"    <leader>mi   Initialize kernel",
		"    <leader>mr   Restart kernel                   PACKAGE MANAGEMENT",
		"    <leader>mx   Interrupt execution                <leader>pi   Install missing packages",
		"    <leader>mI   Show kernel info                   <leader>ps   Show package status",
		"",
