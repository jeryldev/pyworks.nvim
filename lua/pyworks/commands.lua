...
function M.create_commands()
  ...
  vim.api.nvim_create_user_command("PWSetup", function() vim.cmd("PyworksSetup") end, { desc = "Alias for PyworksSetup" })
  vim.api.nvim_create_user_command("PWCheck", function() vim.cmd("PyworksCheck") end, { desc = "Alias for PyworksCheck" })
  vim.api.nvim_create_user_command("PWInstall", function(opts) vim.cmd("PyworksInstall " .. opts.args) end, { nargs = "+", desc = "Alias for PyworksInstall" })
  vim.api.nvim_create_user_command("PWNew", function(opts) vim.cmd("PyworksNew " .. opts.args) end, { nargs = "*", desc = "Alias for PyworksNew" })
end
